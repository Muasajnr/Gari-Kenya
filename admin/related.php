...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_FILES["image"])) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
            ...
            $sql = "INSERT INTO related ( car_image, car_name,car_type, car_price) VALUES ('$targetFile', '$carName','$carType', '$carPrice')";
...
<div class="top">
    ...
    <section class="content">
        <div class="featured-content">
            ...
            <h1>Add Related Vehicles</h1>
            
            <form action="related.php" method="post" enctype="multipart/form-data">
