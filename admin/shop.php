...
$sql = "INSERT INTO shop (car_name, car_type, car_price, manufacture_year, drive, milage, engine_size, fuel, horse_power, transmission, torqu, aspiration, acceleration) 
        VALUES ('$car_name', '$car_type', '$car_price', '$manufacture_year', '$drive', '$milage', '$engine_size', '$fuel', '$horse_power', '$transmission', '$torque', '$aspiration', '$acceleration')";
...
if ($conn->query($sql) === TRUE) {
    ...
    if(isset($_FILES['images'])){
        ...
        for($i = 0; $i < count($images['name']); $i++){
            ...
            $imageName = $last_insert_id . '_' . $i . '_' . $images['name'][$i];
    ...
    // echo "Data and images have been uploaded successfully.";
} else {
...
<div class="top">
    ...
    <div class="specs">
        ...
        <form action="shop.php" method="post" enctype="multipart/form-data" id="image-upload-form" enctype="multipart/form-data">
        <input type="file" name="images[]" id="image-input" multiple accept="image/*" onchange="previewImages()" />
